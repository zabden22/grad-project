const translations = {
    en: {
        ...
        "ai_obs_summary": "AI Observation Summary",
        "cognitive_ai_detect": "Cognitive AI Detection",
        "source_evidence": "Source Evidence",
        "ai_neural_view": "AI Neural View",
        "dismiss_view": "Dismiss View",
        "mark_resolved": "Mark Resolved",
        "image_unavailable": "Image Unavailable",
        "ai_image_expired": "AI Image Expired / Down",
        "report_analysis": "Report Analysis",
        "general": "General",
        "guest_user": "Guest User",
        "no_evidence_data": "No detailed neural data available for this signal.",
        "failed_fetch_reports": "Failed to fetch reports from base console. Check connection.",
        "no_signals_found": "No signals found matching your parameters."
    },
    ar: {
        ...
        "force_refresh": "تحديث إجباري",
        "strategic_reports": "التقارير الاستراتيجية",
        "originator": "المصدر / صاحب البلاغ",
        "intercept_time": "وقت الرصد",
        "threat_level": "مستوى التهديد",
        "ai_obs_summary": "ملخص ملاحظات الذكاء الاصطناعي",
        "cognitive_ai_detect": "الكشف الإدراكي للذكاء الاصطناعي",
        "source_evidence": "دليل المصدر",
        "ai_neural_view": "الرؤية العصبية للذكاء الاصطناعي",
        "dismiss_view": "إغلاق العرض",
        "mark_resolved": "تحديد كمحلول",
        "image_unavailable": "الصورة غير متاحة",
        "ai_image_expired": "رؤية الذكاء الاصطناعي غير متاحة حالياً",
        "report_analysis": "تحليل البلاغ",
        "general": "عام",
        "guest_user": "مستخدم زائر",
        "no_evidence_data": "لا توجد بيانات تفصيلية متاحة لهذه الإشارة.",
        "failed_fetch_reports": "فشل في جلب التقارير من قاعدة البيانات. تحقق من الاتصال.",
        "no_signals_found": "لم يتم العثور على أي بلاغات تطابق البحث."
    }
};

const strictTextMappings = {
    "Login your account": "تسجيل الدخول إلى حسابك",
    "Login to explore": "سجل الدخول للاستكشاف",
    "Password": "كلمة المرور",
    "Forgot password?": "هل نسيت كلمة المرور؟",
    "Continue": "متابعة",
    "No admin accounts found. Create your first one:": "لم يتم العثور على حسابات مشرفين. قم بإنشاء أول حساب:",
    "Setup First Super Admin": "إعداد أول مشرف فائق",
    "Sign in With": "تسجيل الدخول باستخدام",
    "Welcome to the community": "مرحباً بك في مجتمعنا",
    "Login to explore the system": "سجل الدخول لاستكشاف النظام",
    "Back": "رجوع",
    "Forgot Password?": "هل نسيت كلمة المرور؟",
    ...
    "We will send a password reset link to your email address.": "سنرسل رابط إعادة تعيين كلمة المرور إلى بريدك الإلكتروني.",
    "Enter Verification Code": "أدخل رمز التحقق",
    "Please enter the 6-digit OTP sent to": "يرجى إدخال رمز التحقق المكون من 6 أرقام المرسل إلى",
    "your device": "جهازك",
    "Verify Code": "تحقق من الرمز",
    "Didn't receive the code?": "لم تتلق الرمز؟",
    "Resend Code in ": "إعادة إرسال الرمز خلال ",
    "One Step Closer!": "خطوة واحدة أقرب!",
    "Verification helps us keep your account safe and secure. Please do not share this code with anyone.": "يساعدنا التحقق في الحفاظ على أمان حسابك. يرجى عدم مشاركة هذا الرمز مع أي شخص.",
    "Admin Setup": "إعداد المشرف",
    "Create a new administrator account": "إنشاء حساب مشرف جديد",
    "This will create a fresh Auth account and link it to the admins table. Use this if your existing login isn't working.": "سيؤدي هذا إلى إنشاء حساب مصادقة جديد وربطه بجدول المشرفين. استخدم هذا إذا كان تسجيل الدخول الحالي لا يعمل.",
    "Full Name": "الاسم الكامل",
    "Enter your full name": "أدخل اسمك بالكامل",
    "Password (min 6 characters)": "كلمة المرور (6 أحرف على الأقل)",
    "Create secure password": "إنشاء كلمة مرور قوية",
    "Role": "الصلاحية",
    "Create Admin Account": "إنشاء حساب المشرف",
    "Back to Login": "العودة لتسجيل الدخول",
    "Change Password": "تغيير كلمة المرور",
    "Please enter a new password to secure your account": "يرجى إدخال كلمة مرور جديدة لتأمين حسابك",
    "Password strength: Empty": "قوة كلمة المرور: فارغة",
    "Confirm Password": "تأكيد كلمة المرور",
    "Reset Password": "إعادة تعيين كلمة المرور",
    "Security First!": "الأمان أولاً!",
    "Make sure your new password is strong and contains a mix of letters, numbers, and symbols.": "تأكد من أن كلمة المرور الجديدة قوية وتحتوي على مزيج من الأحرف والأرقام والرموز.",
